    ...
    <div className="home-usage">
      ...
      <div className="home-usage-controls">
        ...
        <div className="home-usage-control-group">
          ...
          <div className="home-usage-toggle" role="group" aria-label={t("home.usage.viewAriaLabel")}>
            <button
              type="button"
              className={
                usageMetric === "tokens"
      ...
      {showUsageSkeleton ? (
        ...
        <div className="home-usage-empty">
          <div className="home-usage-empty-title">{t("home.usage.noDataTitle")}</div>
          <div className="home-usage-empty-subtitle">
            {t("home.usage.noDataSubtitle")}
          </div>
          {localUsageError && (
          ...
          <div className="home-usage-chart-card">
              ...
              <div className="home-usage-chart-actions">
                {canShowOlderWeek && (
                  <button
                    ...
                    aria-label={t("home.usage.showPrevWeek")}
                    title={t("home.usage.showPrevWeek")}
                  >
            ...
            <div className="home-usage-chart">
              {chartDays.map((day) => {
                ...
                const tooltip =
                  usageMetric === "tokens"
                    ? t("home.usage.tooltipTokens", {
                        day: formatDayLabel(day.day),
                        count: formatCount(day.totalTokens),
                      })
                    : t("home.usage.tooltipAgentTime", {
                        day: formatDayLabel(day.day),
              ...
              {localUsageSnapshot?.topModels?.length ? (
                localUsageSnapshot.topModels.map((model) => (
                  <span
                    ...
                    key={model.model}
                    title={`${model.model}: ${formatCount(model.tokens)} ${t("home.usage.suffixTokens")}`}
                  >
                    {model.model}
