...
export function SettingsProjectsSection({
  ...
  return (
    ...
    >
              ...
              <div key={group.id} className="settings-group-row">
                <div className="settings-group-fields">
                  ...
                  <div className="settings-group-copies">
                    <div className="settings-group-copies-label">{t("settings.projects.copiesFolder")}</div>
      ...
      <SettingsSubsection
        title={t("settings.projects.projectsSubsection")}
        subtitle={t("settings.projects.projectsSubsectionSubtitle")}
      />
      <div className="settings-projects">
        ...
        {projects.length === 0 && <div className="settings-empty">{t("settings.projects.noProjects")}</div>}
      </div>
    </SettingsSection>
  );
}
