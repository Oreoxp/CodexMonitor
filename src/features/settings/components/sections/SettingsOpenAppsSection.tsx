    ...
    >
              ...
              <div className="settings-open-app-fields">
                <label className="settings-open-app-field settings-open-app-field--label">
                  ...
                  <input
                    ...
                    aria-label={t("settings.openApps.openAppLabelN", { n: index + 1 })}
                ...
                <label className="settings-open-app-field settings-open-app-field--type">
                  ...
                  <select
                    ...
                    aria-label={t("settings.openApps.openAppTypeN", { n: index + 1 })}
                  >
                ...
                {target.kind === "app" && (
                  <label className="settings-open-app-field settings-open-app-field--appname">
                    ...
                    <input
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={t("settings.openApps.openAppNameN", { n: index + 1 })}
                ...
                {target.kind === "command" && (
                  <label className="settings-open-app-field settings-open-app-field--command">
                    ...
                    <input
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={t("settings.openApps.openAppCommandN", { n: index + 1 })}
                ...
                {target.kind !== "finder" && (
                  <label className="settings-open-app-field settings-open-app-field--args">
                    ...
                    <input
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={t("settings.openApps.openAppArgsN", { n: index + 1 })}
                    />
                  </label>
                )}
              </div>
      ...
      <div className="settings-open-app-footer">
        ...
        <div className="settings-help">
          {t("settings.openApps.commandsHelp")}{" "}
          {isMacPlatform()
            ? t("settings.openApps.macAppsHelp")
            : t("settings.openApps.otherAppsHelp")}
        </div>
      </div>
    </SettingsSection>
  );
