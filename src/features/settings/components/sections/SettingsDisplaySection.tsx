...
export function SettingsDisplaySection({
  ...
  return (
    ...
    >
      <div className="settings-subsection-title">{t("settings.display.displaySubtitle")}</div>
      <div className="settings-subsection-subtitle">
        {t("settings.display.displaySubtitleText")}
      </div>
      <div className="settings-field">
        ...
        <div className="settings-help">{t("settings.display.languageSubtitle")}</div>
      </div>
      <div className="settings-field">
      ...
      <SettingsToggleRow
        title={t("settings.display.showRemainingLimitsTitle")}
      ...
      <SettingsToggleRow
        title={t("settings.display.splitChatDiffTitle")}
      ...
      <SettingsToggleRow
        title={t("settings.display.autoGenerateTitlesTitle")}
        subtitle={t("settings.display.autoGenerateTitlesSubtitle")}
      >
        <SettingsToggleSwitch
      ...
      <div className="settings-field">
        ...
        >
          <option value="custom">{t("settings.display.custom")}</option>
          {CHAT_SCROLLBACK_PRESETS.map((value) => (
            <option key={value} value={value}>
              {value === CHAT_SCROLLBACK_DEFAULT ? `${value} (${t("settings.display.default")})` : value}
            </option>
          ))}
        </select>
      ...
      <div className="settings-subsection-title">{t("settings.display.sounds")}</div>
      <div className="settings-subsection-subtitle">{t("settings.display.soundsSubtitle")}</div>
      <SettingsToggleRow
