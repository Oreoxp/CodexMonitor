...
export function SettingsGitSection({
  ...
  return (
    ...
    >
      <SettingsToggleRow
        title={t("settings.git.preloadDiffsTitle")}
      ...
      <div className="settings-field">
        ...
        <div className="settings-help">
          {t("settings.git.commitMessagePromptHelp")} <code>{"{diff}"}</code> {t("settings.git.commitMessagePromptHelpSuffix")}
        </div>
        <textarea
      ...
      {models.length > 0 && (
        <div className="settings-field">
          ...
          >
            <option value="">{t("settings.git.default")}</option>
            {models.map((model) => (
